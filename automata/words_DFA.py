"""
Count words of ANY length in DFA language

© Vladimir Latypov™®
"""

file = open("problem3.in", "r")
...
# For each state count ways from start stare to it
...
open("problem3.out", "w").write(str((sum([dp[-1][i] for i in range(n + 1) if i in terminal])) % (10**9 + 7)))
